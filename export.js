...
export const rbxmxHeader = `<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.roblox.com/roblox.xsd" version="4">
	<Meta name="ExplicitAutoJoints">true</Meta>
	<External>null</External>
	<External>nil</External>`;

export const rbxmxFooter = `
</roblox>`;
...
export const generateImagePart = (rects, imageName, imageWidth, imageHeight, position, transparency) => {
    let frames = '';
    for (const block of rects) {
		frames += generateFrame(
			...
			block.color[1],
			block.color[2],
			transparency ? (block.color[3] ?? 255) : 255
		);
	}
	...
	<Item class="Part">
		<Properties>
			...
			<string name="Name">${imageName}</string>
